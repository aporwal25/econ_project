...
DHS_TFRECORDS_PATH_ROOT = os.path.join('C:/Users/aporw/project new/', 'data/dhs_tfrecords')
DHSNL_TFRECORDS_PATH_ROOT = os.path.join('C:/Users/aporw/project new/', 'data/dhsnl_tfrecords')
